    ...
    >
      ...
      <div className='text-center mb-6'>
        ...
        font-semibold mx-auto leading-[1.2]'>Create amazing content <br />
         with <span className='text-primary'>Al tools</span></h1>
        <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto 
        max-sm:text-xs text-gray-600'>Transform your content creation with our suite of premium Al tools. Write articles, generate images, and enhance your workflow.</p>
      </div>
      ...
      <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
        ...
        border border-gray-400 hover:scale-102 active:scale-95 transition cursor-pointer'>
            Watch demo
        </button>
      </div>
